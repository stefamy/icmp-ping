...
def ping(host, timeout=1):
    # timeout=1 means: If 1 second goes by without a reply from the server, the
    # client assumes that either the client’s ping or the server’s pong is lost
...
# ping("www.governo.it")
# ping("www.japan.go.jp")
ping("www.bundesregierung.de")
